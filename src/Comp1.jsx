...
{/*                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.667 31.69" className="svg">
                    ...
                    <div className="content">
                        ...
                        <span className="text">Gracias por ser lo que sos.</span>
                    </div>
            ...
            <div
                className="layer bg"
                style={{
                    transform: `translate3d(${(mousePosition.x / window.innerWidth) * 50 - 25}px, ${(mousePosition.y / window.innerHeight) * 50 - 25}px, 0) scale(1.5)`
                }}
            ></div>
            <div
                className="layer fg"
                style={{
                    transform: `translate3d(${(mousePosition.x / window.innerWidth) * 30 - 15}px, ${(mousePosition.y / window.innerHeight) * 30 - 15}px, 0) scale(1)`
                }}
            ></div>
        </div>
    );
